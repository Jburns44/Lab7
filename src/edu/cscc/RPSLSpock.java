...
/**
 * RPSLSpock class that will generate a random value and see if it beats the users input
 * @author Jason Burns
 * @version 1.0
 */
public class RPSLSpock {
    ...
    /**
     *
     * @param pick will see if the user input is valid
     * @return takes user input and will print a pick string
     */
    ...
    /**
     *
     * @return generates a pick for the computer at random
     */
    ...
    /**
     *
     * @param c_pick is the computers pick for RPSLSpock
     * @param h_pick is the users pick for RPSLSpock
     * @return prints "computer wins!" if the user loses RPSLSpock
     */
